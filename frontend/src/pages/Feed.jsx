...
const Feed = () => {
    ...
    useEffect(() => {
        ...
        const fetchPosts = async () => {
            try {
                const res = await axios.get(`https://campushub-3-onzw.onrender.com/api/posts/`, {
                    headers: {
    ...
    const toggleLike = async (postId) => {
        try {
            const res = await axios.post(`https://campushub-3-onzw.onrender.com/api/posts/${postId}/like`, {}, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleCommentSubmit = async (e, postId) => {
        ...
        try {
            const res = await axios.post(`https://campushub-3-onzw.onrender.com/api/posts/${postId}/comment`, { text: comment }, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
