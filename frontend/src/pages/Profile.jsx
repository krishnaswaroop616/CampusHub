...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                const res = await axios.get(`https://campushub-3-onzw.onrender.com/api/user/${id}`, {
                    headers: {
        ...
        const fetchProjects = async () => {
            try {
                const res = await axios.get(`https://campushub-3-onzw.onrender.com/api/projects/${id}`, {
    ...
    useEffect(() => {
        const fetchUserPosts = async () => {
            try {
                const res = await axios.get(`https://campushub-3-onzw.onrender.com/api/user/${id}/posts`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
    ...
    const handleDeletePost = async (postId) => {
        try {
            const res = await axios.delete(`https://campushub-3-onzw.onrender.com/api/posts/${postId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleFollow = async () => {
        try {
            await axios.post(`https://campushub-3-onzw.onrender.com/api/user/${id}/follow`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const fetchFollowers = async () => {
        try {
            const res = await axios.get(`https://campushub-3-onzw.onrender.com/api/user/${id}/followers`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const fetchFollowing = async () => {
        try {
            const res = await axios.get(`https://campushub-3-onzw.onrender.com/api/user/${userId}/following`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleProjectSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`https://campushub-3-onzw.onrender.com/api/projects/create`, formatted, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleProjectDelete = async (projectId) => {
        try {
            const res = await axios.delete(`https://campushub-3-onzw.onrender.com/api/projects/delete/${projectId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleProjectUpdate = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.put(`https://campushub-3-onzw.onrender.com/api/projects/update/${editingProject._id}`, editingProject, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
